...
public class ModEntityPlacement {
    public static void spawnPlacement() {
        ...
        EntitySpawnPlacementRegistry.register(EntityTypeRegistry.NETHER_WISP.get(), EntitySpawnPlacementRegistry.PlacementType.NO_RESTRICTIONS, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, WispEntity::checkFlyingCreatureSpawnRules);
        EntitySpawnPlacementRegistry.register(EntityTypeRegistry.ENDER_WISP.get(), EntitySpawnPlacementRegistry.PlacementType.NO_RESTRICTIONS, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, WispEntity::checkFlyingCreatureSpawnRules);
