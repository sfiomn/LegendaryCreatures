...
import sfiomn.legendarycreatures.entities.render.model.ScarabModel;
...
public class ScarabRenderer extends GeoEntityRenderer<ScarabEntity> {
    ...
    @Override
    public RenderType getRenderType(ScarabEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
