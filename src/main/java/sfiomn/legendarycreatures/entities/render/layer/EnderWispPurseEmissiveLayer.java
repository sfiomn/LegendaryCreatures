...
public class EnderWispPurseEmissiveLayer extends GeoRenderLayer<EnderWispPurseEntity> {
    ...
    public EnderWispPurseEmissiveLayer(GeoRenderer<EnderWispPurseEntity> entityRendererIn) {
        super(entityRendererIn);
    }

    public void render(PoseStack poseStack, EnderWispPurseEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
