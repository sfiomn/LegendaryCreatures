...
public class NetherWispPurseEmissiveLayer extends GeoRenderLayer<NetherWispPurseEntity> {
    ...
    public NetherWispPurseEmissiveLayer(GeoRenderer<NetherWispPurseEntity> entityRendererIn) {
        super(entityRendererIn);
    }

    public void render(PoseStack poseStack, NetherWispPurseEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
