...
public class LadybugEntity extends AnimatedCreatureEntity {
    public LadybugEntity(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new RandomStrollGoal(this, 1.0, 200) {
            ...
            protected Vec3 getPosition() {
                return DefaultRandomPos.getPos(this.mob, 8, 7);
            }
        });
    }
