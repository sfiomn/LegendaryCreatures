...
public class CrowsParticle extends TextureSheetParticle {
    protected final SpriteSet animatedSprite;
    private float angle;

    protected CrowsParticle(SpriteSet animatedSprite, ClientLevel level, double x, double y, double z, double xd, double yd, double zd) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType type, @NotNull ClientLevel level, double x, double y, double z, double xd, double yd, double zd) {
            return new CrowsParticle(this.animatedSprite, level, x, y, z, xd, yd, zd);
        }
    }
}
